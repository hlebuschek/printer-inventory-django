...
use constant    blackA4Print     => hpDevice . '.4.1.8.5.1.26.0' ; # A4 black and white
use constant    blackA3Print     => hpDevice . '.4.1.8.5.1.27.0' ; # A3 black and white
...
The module enhances HP printers devices support, including page counters for A3 and A4 formats for black and white printing.