...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--month", type=str, default=None, help="Месяц в формате YYYY-MM (по умолчанию текущий)")
        parser.add_argument("--serial", type=str, default=None, help="Конкретный серийный номер для проверки")
        parser.add_argument("--sync", action="store_true", help="Выполнить синхронизацию")
    ...
    def handle(self, *args, **options):
        ...
        for serial in serials:
            ...
            for task in tasks:
                ...
                if counters:
                    self.stdout.write(
                        f"      Счетчики: A4 ЧБ={counters.bw_a4}, A4 Цвет={counters.color_a4}, "
