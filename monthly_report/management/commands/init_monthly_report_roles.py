...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        editors_full  = g("MonthlyReport Editors (Full)")
        sync_users    = g("MonthlyReport Sync Users")
        ...
        for grp in (viewers, uploaders, editors_start, editors_end, editors_full, sync_users, managers):
