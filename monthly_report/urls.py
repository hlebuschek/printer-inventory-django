...
urlpatterns = [
    ...
    path("api/v2/update-counters/<int:pk>/", api_views_drf.UpdateCountersAPIView.as_view(), name="api_v2_update_counters"),
    path("api/v2/sync/<int:year>/<int:month>/", api_views_drf.SyncFromInventoryAPIView.as_view(), name="api_v2_sync_from_inventory"),
    path("api/v2/reset-manual-flag/<int:pk>/", api_views_drf.ResetManualFlagAPIView.as_view(), name="api_v2_reset_manual_flag"),
    ...
    path("api/v2/toggle-serial-override/", api_views_drf.ToggleSerialOverrideAPIView.as_view(), name="api_v2_toggle_serial_override"),
    path("api/v2/toggle-month-published/", api_views_drf.ToggleMonthPublishedAPIView.as_view(), name="api_v2_toggle_month_published"),
    ...
    path("api/v2/month-users-stats/<int:year>/<int:month>/", api_views_drf.api_month_users_stats_drf, name="api_v2_month_users_stats"),
    path("api/v2/month-changes/<int:year>/<int:month>/", api_views_drf.api_month_changes_list_drf, name="api_v2_month_changes_list"),
    path("api/v2/device-report/<int:year>/<int:month>/<str:serial_number>/", api_views_drf.api_device_report_drf, name="api_v2_device_report"),
    path("api/v2/glpi-export/start/", api_views_drf.StartGLPIExportAPIView.as_view(), name="api_v2_start_glpi_export"),
    path("api/v2/glpi-export/status/<str:task_id>/", api_views_drf.api_glpi_export_status_drf, name="api_v2_glpi_export_status"),
]
