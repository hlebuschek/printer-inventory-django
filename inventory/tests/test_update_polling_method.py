...
from inventory.views.web_parser_vue_view import update_polling_method
...
class UpdatePollingMethodViewTests(TestCase):
    ...
    def test_invalid_polling_method(self):
        ...
        response = self.client.post(
            f'/inventory/{self.printer.id}/api/update-polling-method/',
            data={'polling_method': 'INVALID_METHOD'}
        )
