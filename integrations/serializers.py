...
class CheckDeviceGLPIRequestSerializer(serializers.Serializer):
    ...
    force = serializers.BooleanField(
        help_text="Принудительная проверка (игнорировать кэш)",
        required=False,
        default=False
    )
...
class CreateOkdeskIssueRequestSerializer(serializers.Serializer):
    ...
    cartridge = serializers.CharField(
        help_text="Картридж (опционально)",
        required=False,
        allow_null=True,
        allow_blank=True
    )
    ...
    comment = serializers.CharField(
        help_text="Комментарий (опционально)",
        required=False,
        allow_null=True,
        allow_blank=True
    )
    phone = serializers.CharField(
        help_text="Телефон (опционально)",
        required=False,
        allow_null=True,
        allow_blank=True
    )
...
class PostCommentRequestSerializer(serializers.Serializer):
    ...
    is_public = serializers.BooleanField(
        help_text="Публичный комментарий",
        required=False,
        default=True
    )
...
class SyncNowRequestSerializer(serializers.Serializer):
    ...
    issues = serializers.BooleanField(
        help_text="Синхронизировать заявки",
        required=False,
        default=True
    )
    comments = serializers.BooleanField(
        help_text="Синхронизировать комментарии",
        required=False,
        default=True
    )
