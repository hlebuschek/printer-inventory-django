...
def check_redis_connection():
    ...
    try:
        ...
        return (
            {"status": "ok", "redis": "connected"} if result == "ok" else {"status": "error", "redis": "disconnected"}
        )
...
def debug_tasks(sender, **kwargs):
    ...
    if settings.DEBUG:
        ...
        required_tasks = ["inventory.tasks.inventory_daemon_task", "inventory.tasks.run_inventory_task"]
